...
//                 <div className="product-info">
//                   <div className="rating">
//                     <span>{sharedProduct.rating}</span>
//                     <FaStar />
//                     <span>| {sharedProduct.reviews}</span>
//                   </div>
//                   <h3 className="product-title">{sharedProduct.title}</h3>
//                   <p className="product-description">
//                     {sharedProduct.description}
//                   </p>
//                   <div className="product-pricing">
//                     <span className="current-price">
//                       Rs. {sharedProduct.currentPrice}
//                     </span>
//                     <span className="original-price">
//                       Rs. {sharedProduct.originalPrice}
//                     </span>
//                     <span className="discount">
//                       ({sharedProduct.discount}% OFF)
//                     </span>
//                   </div>
//                 </div>
//               </div>
  ...
  return (
    <div className={styles["chat-container"]}>
      ...
      <div className={styles["chat-body"]} ref={chatBodyRef}>
        ...
        <div className={styles["streak-product-card"]}>
          <div className="product-card">
            <img src="http://localhost:8080/assets/product1.jpg"className="product-image" alt="Product" />
            <div className="product-info">
              <div className="rating">
                <span>4.0</span>
                <FaStar />
        ...
        <div className={styles["streak-product-card"]}>
          <div className="product-card">
            <img src="http://localhost:8080/assets/product2.jpg"className="product-image" alt="Product" />
            <div className="product-info">
              <div className="rating">
                <span>3.9</span>
                <FaStar />
        ...
        <div className={styles["streak-product-card"]}>
          <div className="product-card">
            <img src="http://localhost:8080/assets/product5.jpg" className="product-image" alt="Product" />
            <div className="product-info">
              <div className="rating">
                <span>4.1</span>
                <FaStar />
