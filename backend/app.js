...
//     socket.join(room);
//     console.log(`User ${userId} joined hibib  room ${room}`);
//   });
...
//   //   io.to(room).emit("receiveImage", image);
//   // });
...
io.on("connection", (socket) => {
  ...
  // Uncomment and adjust if needed for handling images and products
  // socket.on("sendImage", ({ room, image }) => {
  //   console.log(`Image received in room ${room}`);
  //   io.to(room).emit("receiveImage", image);
  // });
